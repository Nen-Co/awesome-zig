...
- [Nen-Co/nen-cli](https://github.com/Nen-Co/nen-cli) : Command-line interface for the Nen ecosystem with tools for database management, development workflows, and project scaffolding.
...
- [Nen-Co/nen-io](https://github.com/Nen-Co/nen-io) : High-performance I/O library for Zig with optimized file operations, streaming, batching, and memory-mapped file support for data-intensive applications.
...
- [Nen-Co/nen-json](https://github.com/Nen-Co/nen-json) : High-performance JSON library for Zig with static parsing, zero-copy operations, and optimized memory usage for high-throughput applications.
...
- [Nen-Co/nen-cache](https://github.com/Nen-Co/nen-cache) : High-performance LLM caching system built in Zig with intelligent cache management, vector similarity search, and optimized memory usage for AI applications.
...
- [Nen-Co/nen-db](https://github.com/Nen-Co/nen-db) : Static-memory, crash-safe graph database with AI-native algorithms and HTTP API. Built in Zig for maximum performance with zero dynamic allocations.
...
- [Nen-Co/nen-net](https://github.com/Nen-Co/nen-net) : High-performance networking library for Zig with HTTP server, TCP/UDP support, and optimized I/O operations. Designed for building scalable network applications.
...
- [Nen-Co/nen-db](https://github.com/Nen-Co/nen-db) : High-performance HTTP API server for graph database operations with built-in support for graph algorithms, CRUD operations, and custom queries.
